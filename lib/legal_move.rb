...
class LegalMove
  ...
  def vertical_moves(temp_move_list)
    moves = []
  ...
  def horizontal_moves(temp_move_list)
    moves = []
  ...
  def diagonal_moves(temp_move_list)
    moves = []
...
class MoveQueen < LegalMove
  def moves
    ...
    possible_moves += vertical_moves(temp_move_list)
    possible_moves += horizontal_moves(temp_move_list)
    possible_moves + diagonal_moves(temp_move_list)
  end
end
